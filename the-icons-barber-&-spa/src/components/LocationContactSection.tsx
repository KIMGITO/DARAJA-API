          ...
          <div className="hidden lg:flex lg:col-span-7 flex-col">
            <div className="relative w-full h-full min-h-[340px] bg-background border border-border rounded-xl overflow-hidden shadow-xl">
              ...
              <iframe
                ...
                src={businessInfo.address.mapsEmbedUrl}
                width="100%"
                height="100%"
              ...
              {/* Map Floating Card */}
              <div className="absolute top-3 left-3 right-3 sm:right-auto sm:max-w-xs bg-background/95 backdrop-blur-md border border-border p-3 rounded-lg shadow-xl">
                <div className="flex items-center gap-1.5 text-[11px] font-bold text-primary uppercase tracking-wider mb-0.5">
                  <ShieldCheck className="w-3.5 h-3.5" />
                  <span>Free Reserved Parking</span>
                </div>
                <p className="text-[10px] text-muted-foreground-light leading-tight font-light">
