    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="bg-muted/20 border border-border p-3.5 sm:p-4 rounded-2xl space-y-2.5">
        ...
        <textarea
          ...
          className="w-full bg-input text-foreground text-xs rounded-xl border border-border p-2.5 focus:outline-none focus:border-primary placeholder:text-muted-foreground"
        />
      </div>
